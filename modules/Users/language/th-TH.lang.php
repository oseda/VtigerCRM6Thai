...
'LBL_MODULE_TITLE'=>'ผู้ใช้งาน : หน้าหลัก',
'LBL_SEARCH_FORM_TITLE'=>'ค้นหาผู้ใช้งาน',
'LBL_LIST_FORM_TITLE'=>'รายชื่อ ผู้ใช้งาน',
'LBL_NEW_FORM_TITLE'=>'เพิ่มผู้ใช้งาน',
'LBL_CREATE_NEW_USER'=>'สร้างผู ้ใช้งาน',
'LBL_LOGIN'=>'เข้าระบบ',
'LBL_USER_ROLE'=>'Role',
'LBL_LIST_NAME'=>'ชื่อ',
...
'LBL_LIST_CONFIRM_PASSWORD'=>'ยืนยันรหัสผ่าน',
'LBL_LIST_USER_NAME_ROLE'=>'User ID , Name & Role',
'LBL_LIST_SELECT'=>'เลือก',
'LBL_LIST_PHONE'=>'โทรศัพท์',
'LBL_LIST_NO'=>'#',

'LBL_ADMINS'=>'ระดับผู้ดูแล',
'LBL_STD_USERS'=>'ผู้ใช้ ปกติ',
...
//added for patch2
'LBL_GROUP'=>'กลุ่ม',
'LBL_CURRENCY_NAME'=>'สกุลเงิน',

'LBL_NEW_USER_BUTTON_TITLE'=>'เพิ่ม ผู้ใช้งาน [Alt+N]',
'LBL_NEW_USER_BUTTON_LABEL'=>'เพิ่มผู้ใช้งาน',
'LBL_NEW_USER_BUTTON_KEY'=>'N',
'LBL_DATE_FORMAT'=>'รูปแบบ วันที่',
...
'LBL_LANGUAGE'=>'ภาษา',
'LBL_ADMIN'=>'Admin',
'LBL_OFFICE_PHONE'=>'โทรศัพท์ที ่ทำงาน',
...
'LBL_USER_INFORMATION'=>'ข้อมูล ผู้ใช้งาน',
...
'LBL_ADD_MAIL_ACCOUNT'=>'เพิ่ม บัญชี อีเมล',
'LBL_NEW_MAIL_ACCOUNT_TITLE'=>'เพิ่ม บัญชีอีเมล [Alt+M]',
'LBL_NEW_MAIL_ACCOUNT_KEY'=>'M',
'LBL_NEW_MAIL_ACCOUNT_LABEL'=>'เพิ่ม บัญชีอีเมล',
'LBL_GENERAL_INFO'=>'ข้อมูล ทั่วไป',
'LBL_DISPLAY_NAME'=>'ชื่อ ที่แสดง',
'LBL_MAIL_PROTOCOL'=>'Mail โปรโตคอล',
'LBL_LIST_PASSWORD'=>'รหัสผ่าน',
'LBL_MAIL_SERVER_NAME'=>'ชื่อ Server  เมล์ หรือ  IP',
'LBL_INCOME_SERVER_SETTINGS'=>'Incoming Server',
'LBL_TEST_SETTINGS'=>'ทดสอบ การตั้งค่าเมล์ ทันที',
'LBL_TEST_BUTTON_TITLE'=>'ทดสอบ บัญชีเมล์ เดี๋ยวนี้! [Alt+T]',
'LBL_TEST_BUTTON_KEY'=>'T',
'LBL_TEST_BUTTON_LABEL'=>'ทดสอบ บัญชีเมล์ เดี๋ยวนี้!',
'LBL_DEFAULT'=>'ค่าเริ่มต้น',
'LBL_IMAP2'=>'IMAP2',
'LBL_IMAP4'=>'IMAP4',
'LBL_POP'=>'POP',
'LBL_IMAP'=>'IMAP',
'LBL_MAIL_DISCLAIM'=>'รายการที่มี เครื่องหมาย <font color="red">*</font> ข้อมูลที่จำเป็นต้องกรอก',
...
'LBL_WEB_MAIL_CONFIG'=>'ตั้งค่า เว็บส่งจดหมาย',
'LBL_CONFIGURE_WEB_MAIL'=>' - ตั้งค่า เว็บส่งจดหมาย',
...
'LBL_4_MIN'=>'4 นาที',
'LBL_5_MIN'=>'5 นาที',
'LBL_EMAILS_PER_PAGE'=>'จำนวน เมล ต่อหน้า',
// Added for 5.0.3

'LBL_ENTER_PROFILE'=>'Enter The Profile Name',
'TITLE_USER_DOCUMENT'=>'Untitled Document',
'TITLE_VTIGER_CRM_5'=>'vtiger CRM 5 - ฟรี, Commercial Open Source CRM',
...
'User Login Details'=>'รายละเอียด การเข้าใช้งาน',
